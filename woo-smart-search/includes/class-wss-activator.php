...
class WSS_Activator {
	...
	private static function set_default_options() {
		$defaults = array(
			...
			'widget_layout_mobile'      => 'same',
			'results_columns'           => '3',
			'rp_card_bg'                => '#ffffff',
			'rp_card_border'            => '#e5e7eb',
			'rp_card_radius'            => '8',
			'rp_card_shadow'            => 'medium',
			'rp_price_color'            => '#1f2937',
			'rp_sale_color'             => '#dc2626',
			'rp_badge_bg'               => '#ef4444',
			'rp_badge_text'             => '#ffffff',
			...
			'rp_show_image'             => 'yes',
			'rp_show_category'          => 'yes',
			'rp_show_price'             => 'yes',
			'rp_show_sale_badge'        => 'yes',
			'rp_show_stock'             => 'yes',
			'rp_show_rating'            => 'yes',
			'rp_show_sku'               => 'no',
			'rp_show_description'       => 'no',
			'rp_show_add_to_cart'       => 'no',
			'rp_show_shipping'          => 'no',
			'rp_show_sold'              => 'no',
		);
